...
> 本目录只存放 AegisFlow 项目的角色实例层；跨项目稳定的角色原型位于 `../../../blueprints/roles/`。
...
| [clarifier.md](clarifier.md) | [../../../blueprints/roles/clarifier.md](../../../blueprints/roles/clarifier.md) | 需求澄清师 | PRD 输出路径、索引同步、命名规则 |
